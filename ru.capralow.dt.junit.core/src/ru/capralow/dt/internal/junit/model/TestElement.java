...
//			Assert.isTrue(error.isOK());
	 ...
	 * <ul>
	 * <li>{@link ru.capralow.dt.junit.model.ITestElement.ProgressState#NOT_STARTED}: {@link Double#NaN}</li>
	 * <li>{@link ru.capralow.dt.junit.model.ITestElement.ProgressState#RUNNING}: negated start time</li>
	 * <li>{@link ru.capralow.dt.junit.model.ITestElement.ProgressState#STOPPED}: elapsed time</li>
	 * <li>{@link ru.capralow.dt.junit.model.ITestElement.ProgressState#COMPLETED}: elapsed time</li>
	 * </ul>
	 */
