...
import ru.capralow.dt.internal.junit.util.JUnitStatus;
import ru.capralow.dt.internal.junit.util.JUnitStubUtility;
import ru.capralow.dt.junit.JUnitCore;

public class JUnitContainerWizardPage extends NewElementWizardPage
	...
	public boolean finish() {
		try {
			...
			ExceptionHandler.handle(e,
					getShell(),
					JUnitMessages.JUnitContainerWizardPage_error_title,
					JUnitMessages.JUnitContainerWizardPage_error_problem_configuring_container);
			return false;
		}
		return true;
	}
	...
	public void createControl(Composite parent) {
		...
		} else if (fContainerEntryResult != null
				&& JUnitCore.JUNIT4_CONTAINER_PATH.equals(fContainerEntryResult.getPath())) {
	...
	protected void doSelectionChanged() {
		...
		if (fVersionCombo != null && fVersionCombo.getSelectionIndex() == 2) {
			...
			if (libEntry == null)
				libEntry = BuildPathSupport.getJUnit4as3LibraryEntry(); // JUnit 4 includes most of JUnit 3, so let's
																		// cheat
		}
